...
import HeaderStyle from "./HeaderComponent.module.sass";
...
function Header() {
        ...
        const navToggle = () => {
            active === HeaderStyle.left_sidebar ? setActive(`${HeaderStyle.left_sidebar} ${HeaderStyle.left_sidebar_active}`) : setActive(HeaderStyle.left_sidebar);
        ...
        const sideToggle = () =>{
            sideactive === HeaderStyle.right_sidebar ? setSideactive(`${HeaderStyle.right_sidebar} ${HeaderStyle.right_sidebar_active}`): setSideactive(HeaderStyle.right_sidebar);
        ...
        <div>
            ...
            <div className={HeaderStyle.page_title}>
                <div className={HeaderStyle.title_wrapper}>
                    <div className={HeaderStyle.navBar}>
                        ...
                        <div className={HeaderStyle.top_nav}>
                            <ul className={HeaderStyle.nav}>
                                ...
                                <li>
                                    <a href="#"><FontAwesomeIcon icon={['fas', 'magnifying-glass']} /></a>
                                </li>
                            </ul>
                        </div>
                        <div className={HeaderStyle.toggle_menu_wrapper} >
                            <div className={HeaderStyle.toggle_menu} onClick={navToggle}>
                                <div className={close ? `${HeaderStyle.nav_toggler}` : `${HeaderStyle.nav_close_toggler}`} >
                            ...
                            <div className={HeaderStyle.side_menu} onClick={sideToggle}>
                                <div className={closeSide ? `${HeaderStyle.side_toggler}` : `${HeaderStyle.side_close_toggler}`}>
                                    <div className={HeaderStyle.line_wrapper}>
                                        <div className={HeaderStyle.line1}></div>
                                        <div className={HeaderStyle.line2}></div>
                                        <div className={HeaderStyle.line3}></div>
                    ...
                    <div className={HeaderStyle.breadcumbBar}>
            ...
            <div className={active}>
                <div className={HeaderStyle.leftSide_topWrapper}>
            ...
            <div className={sideactive}>
                <nav className={HeaderStyle.rightSide_nav}>
                    <ul>
                        <li>
                            <a href="#">
                                <FontAwesomeIcon class={HeaderStyle.rightnav_icons} icon={faCircleQuestion}></FontAwesomeIcon>
                                <span>Faq</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <FontAwesomeIcon class={HeaderStyle.rightnav_icons} icon={faPaperPlane}></FontAwesomeIcon>
                                <span>Submit a ticket</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <FontAwesomeIcon class={HeaderStyle.rightnav_icons} icon={faRocket}></FontAwesomeIcon>
                                <span>Terms of use</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <FontAwesomeIcon class={HeaderStyle.rightnav_icons} icon={faFileText}></FontAwesomeIcon>
                                <span>Terms of service</span>      
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <FontAwesomeIcon class={HeaderStyle.rightnav_icons} icon={faPhone}></FontAwesomeIcon>
                ...
                <div className={HeaderStyle.rightSide_nav_bottom}>
                    ...
                    <a href="#">facebook <br /> messenger</a>
                </div>
